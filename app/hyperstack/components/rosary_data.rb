module RosaryData
  PRAYERS = {
    ...
    our_father: {
      name: { en: "Our Father", ml: "സ്വർഗ്ഗസ്ഥനായ പിതാവേ" },
      text: {
    ...
    hail_mary: {
      name: { en: "Hail Mary", ml: "നന്ദി മറിയമേ" },
      text: {
        ...
        ml: "നന്ദി മറിയമേ, കൃപ നിറഞ്ഞവളേ, കർത്താവ് അങ്ങയോടുകൂടെ ഉണ്ട്. അങ്ങ് സ്ത്രീകളിൽ അനുഗൃഹീതയാകുന്നു, അങ്ങയുടെ ഉദരഫലം യേശുവും അനുഗൃഹീതനാകുന്നു. പരിശുദ്ധ മറിയമേ, ദൈവമാതാവേ, പാപികളായ ഞങ്ങൾക്കുവേണ്ടി ഇപ്പോഴും ഞങ്ങളുടെ മരണസമയത്തും അപേക്ഷിക്കണമേ. ആമ്മേൻ."
      }
    },
    glory_be: {
      ...
      text: {
        ...
        ml: "പിതാവിനും പുത്രനും പരിശുദ്ധാത്മാവിനും സ്തുതി. ആദിയിൽ ഇരുന്നതുപോലെ ഇപ്പോഴും എപ്പോഴും എന്നെന്നേക്കും ഉണ്ടായിരിക്കട്ടെ. ആമ്മേൻ."
      }
    },
    fatima: {
      ...
      text: {
        ...
        ml: "യേശുവേ, ഞങ്ങളുടെ പാപങ്ങൾ ക്ഷമിക്കണമേ, നരകാഗ്നിയിൽ നിന്ന് ഞങ്ങളെ രക്ഷിക്കണമേ, സകല ആത്മാക്കളെയും, വിശേഷിച്ച് ഏറ്റവും അധികം ആവശ്യമുള്ളവരെ, സ്വർഗ്ഗത്തിലേക്ക് നടത്തണമേ. ആമ്മേൻ."
      }
    },
    hail_holy_queen: {
